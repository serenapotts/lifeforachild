...
<table>
	<tr>
		<td class="submit">
			...
			<form:form action="${export_excel_url}" method="POST" modelAttribute="reportProperties">
		...
		<td class="submit">
			...
			<form:form action="${export_pdf_url}" method="POST" modelAttribute="reportProperties">
