    ...
    <c:if test="${not empty clinicalrecord}">
        ...
        <div id="roo_clinicalrecord_dateOfMeasurement">
            ...
            <div class="box" id="_dateOfMeasurement">
                <fmt:formatDate pattern="MMM d, yyyy" type="DATE" value="${clinicalrecord.dateOfMeasurement}"/>
            </div>
        </div>
        <br/>
        ...
        <div id="roo_clinicalrecord_ifMenarcheAge">
            ...
            <div class="box" id="_ifMenarcheAge">
                <fmt:formatDate pattern="MMM d, yyyy" type="DATE" value="${clinicalrecord.ifMenarcheAge}"/>
            </div>
        </div>
        <br/>
        ...
        <div id="roo_clinicalrecord_hbA1cPercentage">
            ...
            <div class="box" id="_hbA1cPercentage">${clinicalrecord.hbA1cPercentage}</div>
        </div>
        <br/>
        ...
        <div id="roo_clinicalrecord_reasonHypoglycaemiaEpisodesNotEntered">
            ...
            <div class="box" id="_reasonHypoglycaemiaEpisodesNotEntered">${clinicalrecord.reasonHypoglycaemiaEpisodesNotEntered}</div>
        </div>
        <br/>
        ...
        <div id="roo_clinicalrecord_reasonKetoacidosisEpisodesNotEntered">
            ...
            <div class="box" id="_reasonKetoacidosisEpisodesNotEntered">${clinicalrecord.reasonKetoacidosisEpisodesNotEntered}</div>
        </div>
        <br/>
        ...
        <div id="roo_clinicalrecord_reasonHospitalAdmissionsNotEntered">
            ...
            <div class="box" id="_reasonHospitalAdmissionsNotEntered">${clinicalrecord.reasonHospitalAdmissionsNotEntered}</div>
        </div>
        <br/>
        ...
        <div id="roo_clinicalrecord_dateCompleted">
            ...
            <div class="box" id="_dateCompleted">
                <fmt:formatDate pattern="MMM d, yyyy" type="DATE" value="${clinicalrecord.dateCompleted}"/>
            </div>
        </div>
        <br/>
